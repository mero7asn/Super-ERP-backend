...
router.get('/users', protect, authorizeRoles('Core 360 Administrator', 'System Architect'), getUsers);
...
router.delete('/users', protect, authorizeRoles('Core 360 Administrator'), (req, res) => {
