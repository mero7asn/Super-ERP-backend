...
const MyTeamPage = () => {
  ...
  const fetchTeams = useCallback(async () => {
    setLoading(true);
    try {
      const { data } = await API.get('/auth/teams', { params: { scope: 'mine' } });
      setTeams(data.teams || []);
  ...
  if (loading) return <div className="loading-state"><div className="spinner" />Loading your team…</div>;
  ...
  return (
    <div>
      <PageHeader
        title="My Team"
        subtitle="The teams you belong to and the people who report to you"
        icon={
