...
exports.getBusinessModel = async (req, res) => {
  try {
    if (!['Super CRM Administrator', 'Super Admin', 'Administrator', 'Super CRM Administrator', 'Super Admin', 'Administrator', 'CRM core Administrator', 'Core 360 Administrator', 'System Architect', 'Executive User'].includes(req.user.role)) {
...
exports.updateBusinessModel = async (req, res) => {
  try {
    ...
    const isSuperAdmin = ['Super CRM Administrator', 'Super Admin', 'Administrator', 'Super CRM Administrator', 'Super Admin', 'Administrator', 'CRM core Administrator', 'Core 360 Administrator'].includes(req.user.role);
    let onboarded = false;
    if (isSuperAdmin) {
